<div id="meny" class="shadow">
		...
		if(isset($_SESSION['user'])){ 
        	echo '<a href="Min-Sida"><img src="./images/user.png" alt="min sida"><small>Min sida</small></a>';
		}else{
        	echo '<a href="logIn"><img src="./images/user.png" alt="logga in"><small>Logga in</small></a>';
		}
		...
		<nav>
            <h3><a href="./">Hem</a></h3>
            <h3><a href="help">Hur fungerar det?</a></h3>
            <h3><a href="hittaPizzeria">Hitta din pizzeria</a></h3>
		</nav>
